...
//  Knobler
//
//  Enviar arquivo do shelf pelo menu de compartilhamento do sistema. O envio
//  direto por AirDrop mora em AirDrop/AirDropEnvio.swift. O app é LSUIElement
//  com painel nonactivating — sem ativar antes, o picker nasce atrás de tudo.
//
