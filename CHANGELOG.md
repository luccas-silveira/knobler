...
- **Histórico de notificações (24 h)**: puxe o card do notch pra baixo numa
  ...
  disparado e atividade da API local das últimas 24 h. Uma alcinha no rodapé
  do card aberto avisa que dá pra puxar. Fechar é tirar o mouse (não gesto);
  com a cortina aberta, o scroll pertence à lista. Mora só em memória — não
  sobrevive ao restart do Knobler.
- **Nota rápida**: **✎ Nota rápida** no menu da barra (◐) liga um campo de
  ...
  aberto mesmo com o mouse fora; **Esc** solta o foco. Desligar o interruptor
  apaga o texto. Sem persistência entre restarts.
