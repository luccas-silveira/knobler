...
- **Now Playing** (Spotify e Apple Music): capa + visualizador no notch fechado;
  ...
  hover "espia" antes de abrir. → [detalhes](../../now-playing.md)
...
- **API local** (`127.0.0.1:4477`) — o diferencial: qualquer script publica no notch.
  → [detalhes](../../local-api.md)

Configuração de tudo isso numa janela de Ajustes única. → [detalhes](../../settings.md)
```
