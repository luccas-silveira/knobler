# Handoffs arquivados — julho/2026

Sessões já encerradas, movidas de `HANDOFF.md` para mantê-lo operacional — o
`HANDOFF.md` guarda só as últimas, em ordem decrescente. O histórico canônico de
mudanças é o `CHANGELOG.md`; isto aqui guarda o raciocínio e os becos sem saída
de cada sessão.
...
- `defaults write` em `shelfItems` e `notchSectionOrder` (o `shelfItems` virou
  array de arrays no ticket 004 — a receita atual está na skill `snapshot-ui`);
...
- ~~Dois clones do tap~~ — resolvido eliminando a possibilidade de divergir, não
  ...
  [development.md](../development.md#release).
...
[`docs/handoffs/2026-07.md`](../handoffs/2026-07.md).
...
[`docs/handoffs/2026-07.md`](../handoffs/2026-07.md) — este arquivo guarda só
...
- Documentação reorganizada por objetivo em [`docs/index.md`](../index.md),
...
- grill-me (8 decisões) → `docs/superpowers/specs/2026-07-19-descanso-design.md` → **pesquisa (Swift real + web/campo)** que corrigiu 3 premissas:
...
- grill-me (9 decisões) → `docs/superpowers/specs/2026-07-18-lembretes-design.md` → **pesquisa com Swift real** (pegou 3 armadilhas antes do código:
