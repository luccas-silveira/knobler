...
Sessões anteriores a 26/07/2026, movidas de `HANDOFF.md` para mantê-lo
operacional. O histórico canônico de mudanças é o `CHANGELOG.md`; isto aqui
guarda o raciocínio e os becos sem saída de cada sessão.
